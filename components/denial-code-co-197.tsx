                    ...
                    <div className="text-center space-y-6">
                        <div className="space-y-4">
                            ...
                            <p className="text-lg sm:text-xl text-[#666666] mx-auto text-left leading-relaxed">
                                This document provides a comprehensive overview of Denial Code CO-197, which is used to indicate that a claim has been denied due to the absence of a valid authorization or referral. Understanding this code is crucial for healthcare providers and billing professionals to ensure proper claim submission and avoid denials.<br/>At mindfultalk.in, we specialize in creating detailed and accessible documentation that helps stakeholders navigate complex healthcare billing processes.
                            </p>
                        </div>
                    </div>
